...
## Generated on : Thu Oct 21 12:01:35 2021
...
START_DIR                 = $(MATLAB_WORKSPACE)/E/Puppy_positionBasedMPC
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
joystick_raspi.c.o : $(START_DIR)/joyStick_driver/src/joystick_raspi.c
	$(CC) $(CFLAGS) -o "$@" "$<"
