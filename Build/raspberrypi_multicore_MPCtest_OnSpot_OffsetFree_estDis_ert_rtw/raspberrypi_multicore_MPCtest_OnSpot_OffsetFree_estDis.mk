...
## Generated on : Fri Oct 22 11:00:09 2021
...
PRODUCT_NAME              = raspberrypi_multicore_MPCtest_OnSpot_OffsetFree_estDis
MAKEFILE                  = raspberrypi_multicore_MPCtest_OnSpot_OffsetFree_estDis.mk
...
START_DIR                 = $(MATLAB_WORKSPACE)/E/Puppy_positionBasedMPC/Build
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/raspberrypi_multicore_MPCtest_OnSpot_OffsetFree_estDis.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(MATLAB_WORKSPACE)/E/Puppy_positionBasedMPC/joyStick_driver/include -I$(MATLAB_WORKSPACE)/C/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/target/shared/svd/include -I$(MATLAB_WORKSPACE)/C/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/realtime/targets/raspi/include -I$(MATLAB_WORKSPACE)/C/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/realtime/targets/linux/include -I$(START_DIR)/raspberrypi_multicore_MPCtest_OnSpot_OffsetFree_estDis_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/slave/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/slave/common -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/slave/protocol/src -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/slave/protocol/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/slave/transport/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/slave/transport/src -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/slave/platform/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/slave/platform/default -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/ext_mode/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/ext_mode/src -I$(MATLAB_ROOT)/rtw/c/ext_mode/common -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -I$(MATLAB_ROOT)/toolbox/target/codertarget/rtos/inc
...
DEFINES_ = -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DMW_RASPI_DETECTOVERRUN
...
DEFINES_CUSTOM = 
DEFINES_OPTS = -DXCP_DAQ_SUPPORT -DXCP_CALIBRATION_SUPPORT -DXCP_TIMESTAMP_SUPPORT -DXCP_TIMESTAMP_BASED_ON_SIMULATION_TIME -DXCP_SET_MTA_SUPPORT -DXCP_MEM_DAQ_RESERVED_POOLS_NUMBER=2 -DEXTMODE_XCP_TRIGGER_SUPPORT -DEXTMODE_STATIC -DEXTMODE_STATIC_SIZE=1000000 -DON_TARGET_WAIT_FOR_START=1 -DTID01EQ=0
DEFINES_SKIPFORSIL = -D__linux__ -DARM_PROJECT -D_USE_TARGET_UDP_ -D_RUNONTARGETHARDWARE_BUILD_ -DSTACK_SIZE=64 -DRT
DEFINES_STANDARD = -DMODEL=raspberrypi_multicore_MPCtest_OnSpot_OffsetFree_estDis -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(MATLAB_WORKSPACE)/E/Puppy_positionBasedMPC/joyStick_driver/src/joystick_raspi.c $(MATLAB_WORKSPACE)/xcp_ext_work.c $(START_DIR)/raspberrypi_multicore_MPCtest_OnSpot_OffsetFree_estDis_ert_rtw/rtw_linux.c $(START_DIR)/raspberrypi_multicore_MPCtest_OnSpot_OffsetFree_estDis_ert_rtw/raspberrypi_multicore_MPCtest_OnSpot_OffsetFree_estDis.c $(START_DIR)/raspberrypi_multicore_MPCtest_OnSpot_OffsetFree_estDis_ert_rtw/raspberrypi_multicore_MPCtest_OnSpot_OffsetFree_estDis_data.c $(START_DIR)/raspberrypi_multicore_MPCtest_OnSpot_OffsetFree_estDis_ert_rtw/rtGetInf.c $(START_DIR)/raspberrypi_multicore_MPCtest_OnSpot_OffsetFree_estDis_ert_rtw/rtGetNaN.c $(START_DIR)/raspberrypi_multicore_MPCtest_OnSpot_OffsetFree_estDis_ert_rtw/rt_nonfinite.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/ext_mode/src/xcp_ext_common.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/ext_mode/src/xcp_ext_classic_trigger.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/slave/protocol/src/xcp.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/slave/protocol/src/xcp_standard.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/slave/protocol/src/xcp_daq.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/slave/protocol/src/xcp_calibration.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/slave/transport/src/xcp_fifo.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/slave/transport/src/xcp_transport.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/slave/platform/default/xcp_mem_default.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/slave/platform/default/xcp_drv_rtiostream.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/slave/transport/src/xcp_frame_tcp.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/ext_mode/src/xcp_ext_param_default_tcp.c $(MATLAB_WORKSPACE)/C/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/realtime/targets/raspi/src/MW_raspi_init.c $(MATLAB_WORKSPACE)/C/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/realtime/targets/raspi/src/periphs/MW_Pyserver_control.c $(MATLAB_ROOT)/toolbox/target/codertarget/rtos/src/linuxinitialize.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/rtiostream_interface.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/rtiostreamtcpip/rtiostream_tcpip.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils/rtiostream_utils.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/slave/platform/default/xcp_platform_default.c

MAIN_SRC = $(START_DIR)/raspberrypi_multicore_MPCtest_OnSpot_OffsetFree_estDis_ert_rtw/ert_main.c
...
OBJS = joystick_raspi.c.o xcp_ext_work.c.o rtw_linux.c.o raspberrypi_multicore_MPCtest_OnSpot_OffsetFree_estDis.c.o raspberrypi_multicore_MPCtest_OnSpot_OffsetFree_estDis_data.c.o rtGetInf.c.o rtGetNaN.c.o rt_nonfinite.c.o xcp_ext_common.c.o xcp_ext_classic_trigger.c.o xcp.c.o xcp_standard.c.o xcp_daq.c.o xcp_calibration.c.o xcp_fifo.c.o xcp_transport.c.o xcp_mem_default.c.o xcp_drv_rtiostream.c.o xcp_frame_tcp.c.o xcp_ext_param_default_tcp.c.o MW_raspi_init.c.o MW_Pyserver_control.c.o linuxinitialize.c.o rtiostream_interface.c.o rtiostream_tcpip.c.o rtiostream_utils.c.o xcp_platform_default.c.o
...
LDFLAGS_ = -lpthread -lpthread -lpthread -lpthread
...
SHAREDLIB_LDFLAGS_ = -lpthread -lpthread -lpthread -lpthread
...
CPP_LDFLAGS_ = -lpthread -lpthread -lpthread -lpthread
...
CPP_SHAREDLIB_LDFLAGS_ = -lpthread -lpthread -lpthread -lpthread
...
%.c.o : $(START_DIR)/raspberrypi_multicore_MPCtest_OnSpot_OffsetFree_estDis_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.s.o : $(START_DIR)/raspberrypi_multicore_MPCtest_OnSpot_OffsetFree_estDis_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"


%.cpp.o : $(START_DIR)/raspberrypi_multicore_MPCtest_OnSpot_OffsetFree_estDis_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
joystick_raspi.c.o : $(MATLAB_WORKSPACE)/E/Puppy_positionBasedMPC/joyStick_driver/src/joystick_raspi.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.c.o : $(START_DIR)/raspberrypi_multicore_MPCtest_OnSpot_OffsetFree_estDis_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtw_linux.c.o : $(START_DIR)/raspberrypi_multicore_MPCtest_OnSpot_OffsetFree_estDis_ert_rtw/rtw_linux.c
	$(CC) $(CFLAGS) -o "$@" "$<"


raspberrypi_multicore_MPCtest_OnSpot_OffsetFree_estDis.c.o : $(START_DIR)/raspberrypi_multicore_MPCtest_OnSpot_OffsetFree_estDis_ert_rtw/raspberrypi_multicore_MPCtest_OnSpot_OffsetFree_estDis.c
	$(CC) $(CFLAGS) -o "$@" "$<"


raspberrypi_multicore_MPCtest_OnSpot_OffsetFree_estDis_data.c.o : $(START_DIR)/raspberrypi_multicore_MPCtest_OnSpot_OffsetFree_estDis_ert_rtw/raspberrypi_multicore_MPCtest_OnSpot_OffsetFree_estDis_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.c.o : $(START_DIR)/raspberrypi_multicore_MPCtest_OnSpot_OffsetFree_estDis_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.c.o : $(START_DIR)/raspberrypi_multicore_MPCtest_OnSpot_OffsetFree_estDis_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.c.o : $(START_DIR)/raspberrypi_multicore_MPCtest_OnSpot_OffsetFree_estDis_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
