...
#ifndef struct_tag_Xki1WZVY1H0NYuloR66DuB
#define struct_tag_Xki1WZVY1H0NYuloR66DuB

struct tag_Xki1WZVY1H0NYuloR66DuB
{
  int32_T isInitialized;
  real_T Ts;
  real_T m;
  real_T Inorm[9];
  real_T estXbarOld[25];
  real_T UOld[12];
};

#endif                                 /* struct_tag_Xki1WZVY1H0NYuloR66DuB */

#ifndef typedef_algebraicDisEstmator_raspberr_T
#define typedef_algebraicDisEstmator_raspberr_T

typedef struct tag_Xki1WZVY1H0NYuloR66DuB algebraicDisEstmator_raspberr_T;

#endif                             /* typedef_algebraicDisEstmator_raspberr_T */
